...
function TasksComp(props)
{
    ...
    return(<div style={{height: "305px", overflowY: "scroll", float: "right",  width: "49%"}}>
        ...
        { showTodo==true ? //check if clicked add todo
            ...
            <div> 
                ...
                <div className='box' style={{height: '50px'}}>
                    ...
                    Title:  &nbsp;&nbsp;<input style={{width: '40%'}} type="text" onChange={e=> setNewTask(e.target.value)}/><br/>
        ...
        { showPost==true ? //check if clicked add post
            ...
            <div>
                ...
                <div className='box' style={{height: "93px"}}>
                    ...
                    Title:  &nbsp;&nbsp;<input style={{width: '40%'}} type="text" onChange={e=> setNewTitle(e.target.value)}/><br/><br/>
                    Body:  &nbsp;&nbsp;<input style={{width: '40%'}} type="text" onChange={e=> setNewBody(e.target.value)}/><br/>
