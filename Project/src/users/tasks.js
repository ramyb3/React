...
function TasksComp(props)
{
    ...
    return(<div style={{height: "270px", overflowY: "scroll", float: "right",  width: "49%"}}>
        ...
        <div style={{borderColor: "black", borderStyle: "solid"}}>
            <input className="Right" style={{backgroundColor: "yellow", cursor: "pointer"}} type="button" value="Add" onClick={addTodo}/>
            ...
            
            {
                props.tasks.map((x,index)=> //all todos
                {
                    return(<div><div key={index} style={{borderColor: "purple", borderStyle: "solid", height: "65px"}}>
                        ...
                        <input className="Right" name={index} style={{backgroundColor: "yellow", cursor: "pointer"}}
        ...
        <div> 
            ...
            <div style={{borderColor: "black", borderStyle: "solid", height: "50px"}}>
                ...
                <input style={{backgroundColor: "yellow", cursor: "pointer"}} type="button" id="todo" value="Cancel" onClick={cancel}/>
                &nbsp;&nbsp;{/* 2 spaces */}
                <input style={{backgroundColor: "yellow", cursor: "pointer"}} type="button" id="todo" value="Add" onClick={add}/>&nbsp;
        ...
        <div style={{borderColor: "black", borderStyle: "solid"}}>
            ...
            <input className="Right" style={{backgroundColor: "yellow", cursor: "pointer"}} type="button" value="Add" onClick={addPost}/>
        ...
        <div>
            ...
            <div style={{borderColor: "black", borderStyle: "solid", height: "93px"}}>
                ...
                <input style={{backgroundColor: "yellow", cursor: "pointer"}} type="button" id="post" value="Cancel" onClick={cancel}/>
                &nbsp;&nbsp;{/* 2 spaces */}
                <input style={{backgroundColor: "yellow", cursor: "pointer"}} type="button" id="post" value="Add" onClick={add}/>&nbsp;
