...
function Add(props)
{
    ...
    return(<div style={{borderStyle: "solid", borderColor: "black", width: "400px", height: "75px"}}>
        ...
        <div className="Right">
            ...
            <input style={{backgroundColor: "yellow", cursor: "pointer"}} type="button" value="Cancel" onClick={cancel}/>
            &nbsp;&nbsp;{/* 2 spaces */}
            <input style={{backgroundColor: "yellow", cursor: "pointer"}} type="button" value="Add" onClick={add}/>&nbsp;
