...
function First(props)
{
    ...
    return(<div>
        ...
        <div id={props.user.id+100} style={{borderColor: check, borderStyle: "solid", width: "49%"}}> 
            ...
            <input style={{backgroundColor: "grey"}} type="button" value="Other Data" onClick={close} onMouseOver={showData}/>
            &nbsp;&nbsp;{/* 2 spaces */}
            <input style={{backgroundColor: "yellow"}} type="button" value="Update" onClick={update}/>
            &nbsp;&nbsp;{/* 2 spaces */}
            <input style={{backgroundColor: "yellow"}} type="button" value="Delete" onClick={deleteData}/> <br/><br/>
